...
header('location:login.php');
	...
	if(isset($_POST['update']))
	{
		...
		{
echo "<script>alert('
Tu información ha sido actualizada');</script>";
		}
	}
...
echo "<script>alert('Actualizacion de Contraseña');</script>";
}
else
{
	echo "<script>alert('
...
<div class="form-group">
			 ...
			 <input type="email" class="form-control unicase-form-control text-input" id="exampleInputEmail1" value="<?php echo $row['email'];?>" readonly>
					  ...
					  <div class="form-group">
					    <label class="info-title" for="Contact No.">Telefono<span>*</span></label>
					  ...
					  <button type="submit" name="update" class="btn-upper btn btn-primary checkout-page-button">Actualizar Datos</button>
					</form>
					<?php } ?>
				</div>	
...
<div class="form-group">
					    <label class="info-title" for="Current Password">Actual Contraseña<span>*</span></label>
			 ...
			 <input type="password" class="form-control unicase-form-control text-input" id="newpass" name="newpass">
					  ...
					  <button type="submit" name="submit" class="btn-upper btn btn-primary checkout-page-button">Guardar Cambios </button>
					</form> 
