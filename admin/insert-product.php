...
<head>
	...
	<title>Administracion| Ingresar Productos</title>
...
<div class="controls">
<input type="text"    name="productName"  placeholder="Ingresar el Nombre del Producto" class="span8 tip" required>
</div>
</div>
...
<div class="controls">
<input type="text"    name="productCompany"  placeholder="Ingresar la Marca" class="span8 tip" required>
</div>
</div>
<div class="control-group">
<label class="control-label" for="basicinput">Precio antes del descuento</label>
<div class="controls">
<input type="text"    name="productpricebd"  placeholder="Ingresar el precio del producto antes del descuento" class="span8 tip" required>
</div>
</div>
...
<div class="controls">
<input type="text"    name="productprice"  placeholder="Ingrese el precio de venta" class="span8 tip" required>
</div>
</div>
