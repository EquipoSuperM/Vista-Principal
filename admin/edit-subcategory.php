...
<head>
	...
	<title>Administracion| Editar Sub-Categoria</title>
...
<div class="controls">
<input type="text" placeholder="Ingrese el nombre de la Sub-Categoria"  name="subcategory" value="<?php echo  htmlentities($row['subcategory']);?>" class="span8 tip" required>
</div>
</div>
