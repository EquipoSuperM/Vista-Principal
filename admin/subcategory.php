...
<head>
	...
	<title>Administracion| Sub-Categoria</title>
...
<div class="controls">
<input type="text" placeholder="Ingresa el Nombre de la Sub-Categoria"  name="subcategory" class="span8 tip" required>
</div>
</div>
